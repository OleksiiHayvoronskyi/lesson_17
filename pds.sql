...
-- PHP Version: 5.4.23employees

-- ЛЕКЦІЯ 17 --
-- Завдання 1. Запит, щоб перерахувати кількість вакансій у таблиці --
SELECT COUNT(DISTINCT job_id) 
FROM employees;

-- Завдання 2. Запит, щоб отримати середню заробітну плату та кількість працівників відділу 90. ---
...
-- Завдання 4. Запит, щоб знайти назву і код відділу, а також імена та прізвища працівників цього відділу. --       
...
-- Завдання 5. Запит, щоб знайти імена та прізвища, роботу, ідентифікатор відділу та імена співробітників, що працюють у Лондоні. --
